...
public partial class MyImageContext : DbContext
{
    ...
    //=> optionsBuilder.UseSqlServer("Server=tcp:myimageserver.database.windows.net,1433;Initial Catalog=myimagesdb;Persist Security Info=False;User ID=admin1;Password=a123456!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
