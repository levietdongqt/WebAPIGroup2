...
public partial class MyImageContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("server=DESKTOP-9KMLCE8;Database=MyImages;User ID=sa;Password=thuhuy;Trusted_Connection=true;MultipleActiveResultSets=true;TrustServerCertificate=true");
