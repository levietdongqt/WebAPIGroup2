...
public partial class MyImageContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("server=DESKTOP-3FQ63QJ;Database=MyImages;User ID=sa;Password=thuhuy;Trusted_Connection=true;MultipleActiveResultSets=true;TrustServerCertificate=true");
